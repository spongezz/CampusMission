...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=METRICS[0],
        dest="metric",
        help="metric to plot on the y-axis, valid choices are: %s" % ", ".join(
            METRICS),
    )
    parser.add_argument(
        "-t",
    ...
    parser.add_argument(
        "--xlabel", type=str, default="Size of matrix", help="label of the x-axis"
    )
    ...
    parser.add_argument(
        "--output", type=str, default="./figure.png", help="File in which to save the graph"
    )
